function [ edges, errors, labels ] = quantizeNL_new( y, nclust )
% y is input data (one dimensional)
...
% errors are the cumulative errors (SSD) in each bin
% labels are the output values assigned to each member of y after
% quantization
